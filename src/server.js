...
function createApp({ store, config, nocoDb }) {
  ...
  app.post("/jobs", (req, res) => {
    ...
    const mode = String(req.body.mode || "discovery").trim().toLowerCase();
    const { hashtags } = resolveSearchParams({
      keyword,
